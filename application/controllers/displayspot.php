...
class Displayspot extends CI_Controller {
	...
	{
		$this->load->model('displayspot_model');
	        $data['query']=$this->displayspot_model->spot_getall();
                $this->load->view('header.php');
                $this->load->view('top.php');
		$this->load->view('spot/display.php',$data);
         ...
         public function edit($id=0)
	{
			...
			$add['data']['primary']           = $this->input->post('primary');
                        ...
                        if ($this->form_validation->run() == FALSE)
                           ...
                           $this->load->model('displayspot_model');
	                   $data['query']=$this->displayspot_model->spot_getedit($id);
