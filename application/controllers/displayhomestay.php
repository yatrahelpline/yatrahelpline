...
class Displayhomestay extends CI_Controller {
	...
	{
		$this->load->model('displayhomestay_model');
	        $data['query']=$this->displayhomestay_model->homestay_getall();
                $this->load->view('header.php');
                $this->load->view('top.php');
		$this->load->view('homestay/display.php',$data);
         ...
         public function edit($id=0)
	{
			...
			$add['data']['roomrate']           = $this->input->post('roomrate');
                        ...
                        if ($this->form_validation->run() == FALSE)
                           ...
                           $this->load->model('displayhomestay_model');
	                   $data['query']=$this->displayhomestay_model->homestay_getedit($id);


              $this->load->view('header.php');
              $this->load->view('top.php');
	      $this->load->view('homestay/contentedit.php',$data);
              $this->load->view('footer.php');
